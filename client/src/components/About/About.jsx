    ...
    <div className="container">
      <div className="about-content">
        ...
        <div className="about-content-right">
          <img
            src="http://localhost:4000/img/img_about/about1.jpg"
            width="600px"
            height="600px"
            alt="about-img"
          />
      ...
      <div className="about-content">
        <div className="about-content-left">
          <img
            src="http://localhost:4000/img/img_about/2.jpg"
            width="600px"
            height="600px"
            alt="about-img"
          />
        ...
        <div className="about-content-right">
          ...
          <p>
            ...
            транспортировки и украшенные декоративными лентами. Мы постоянно
            обновляем нашу коллекцию букетов и композиций в зависимости от
            сезона, находимся в поиске интересных сортов и решений, следуем
            новейшим флористическим тенденциям!
          </p>
        </div>
      </div>
      ...
      <div className="about-content">
        ...
        <div className="about-content-right">
          <img
            src="http://localhost:4000/img/img_about/3.jpg"
            width="600px"
            height="600px"
            alt="about-img"
          />
